...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            File your_file_name = File.createTempFile("2005", null, new File("/home/maksim/1/"));
            ...
            System.out.println(ivanov.name + " " + somePerson.name);
    ...
    public static class Human {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            this.name = tmp.equals("null")?null:tmp;
            String assetName;
