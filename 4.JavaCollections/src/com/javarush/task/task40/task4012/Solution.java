...
public class Solution {
    ...
    public static Period getPeriodBetween(LocalDate firstDate, LocalDate secondDate) {
        LocalDate min = firstDate.isBefore(secondDate) ? firstDate : secondDate;
        LocalDate max = firstDate.isAfter(secondDate) ? firstDate : secondDate;
        return Period.between(min, max);
    }
}
